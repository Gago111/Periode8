...
<body>
  ...
  <div class="navigation">
    ...
    <div class="banner img-fluid" style="background-image: url(assets/img/headers/header5.jpg);
      ...
      <div class="container">
        <div class="text-center">
          <h1 style="font-size:40px;" class="text-center text-white">Verkoop</h1>
        </div>
      </div>
    </div> <!-- END bg-dark -->
  </div>
  ...
  <div class="container">
    <div class="title-section pt-4">
      <h2 class="text-center pb-2 blue">Zoekt uw bedrijf op regelmatige basis gereviseerde smartphones of ICT apparatuur ?</h2>
      <div class="row">
        <div class="col-md-12 text-center pb-3">
          <p>U kunt dan business partner van Detona worden en als “preferred customer” profiteren van de aantrekkelijke kortingen en online inzicht in het verwachte en actuele aanbod.</p>
        </div>
      </div>
    </div>
    ...
    <div class="pb-3">
      <div class="row">
        <div class="col-md-12">
          <h2 class="blue pb-4">Contactformulier</h2>
